...
const HeroSection = () => {
  ...
  >
    ...
    <img src={ggl} alt="Google rating" className="img-fluid" style={{ width: '200px', height: '100px', objectFit: 'cover', borderRadius: '8px' }} />
    <img src={jd} alt="Justdial rating" className="img-fluid" style={{ width: '200px', height: '100px', objectFit: 'cover', borderRadius: '8px' }} />
  </div>
